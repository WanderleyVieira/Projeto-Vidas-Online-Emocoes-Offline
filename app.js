...
// ════════════════════════════════════════════════════
//  9. PONTE DE INTEGRAÇÃO COM IA (NOVO)
// ════════════════════════════════════════════════════
...
function integrarIAComDadosReais() {
    ...
    // _filtrados contém os pontos de cultura atuais após os filtros do usuário
    if (typeof gerarRecomendacaoCultural === "function") {
        if (!humorUsuario) {
            alert("Por favor, descreva como você se sente no campo da IA!");
            return;
        }
        // Envia o humor, a localização selecionada e os dados reais filtrados para a IA
